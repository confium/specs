...
CNML (Certificat Numérique de Métrologie Légale) flagship
deployment under the SMART metrology program operated by Ribose.
...
*Examples*: CNML, calibration authorities, pharmaceutical regulator drug
...
plus interfaces for all specified algorithms.

Pre-1.0 work continues toward stabilization.
