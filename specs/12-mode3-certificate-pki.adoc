...
The OIML CNML project is the Mode 3 flagship. It demonstrates Confium
...
See link:40-deployment-manifest.adoc[40 — Deployment manifest] for the
schema.
...
* Engineering docs: `TODO.roadmap/27-cnml-deployment.md`, `TODO.roadmap/33-config-manifest.md`
