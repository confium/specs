...
**Draft.** Authoritative live version: link:https://github.com/confium/confium/blob/main/docs/bindings/parity.mdx[the parity matrix in the confium repo].
...
* Live matrix: link:https://github.com/confium/confium/blob/main/docs/bindings/parity.mdx[parity matrix]
